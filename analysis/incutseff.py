...
def saveplots(plots_dic,plotseff_dic,plots2d_dic,counts_dic,olist):
	for key in plots_dic:
		ofile = "output/%s_cutsel.pdf"%(key.replace(" ","_"))
		...
		for i,li in enumerate(olist):
			ypos = 0.4-i*.05
			nevents_text[i] = ROOT.TText(0.5,ypos,"\n nevents %s: %s(c1:%s(%s),c2:%s(%s),c3:%s(%s),c4:%s(%s))"%(li,counts_dic[key][i][0][0],counts_dic[key][i][0][1],counts_dic[key][i][1][1],counts_dic[key][i][0][2],counts_dic[key][i][1][2],counts_dic[key][i][0][3],counts_dic[key][i][1][3],counts_dic[key][i][0][4],counts_dic[key][i][1][4]))
